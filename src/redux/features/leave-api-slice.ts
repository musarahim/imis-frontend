  ...
  endpoints: (builder) => ({
    ...
    patchLeaveApplication: builder.mutation({
      query: ({
        id,
        ...patch
      }: { id: number } & Partial<LeaveApplication>) => ({
    ...
    getLeaveDelegations: builder.query<
      ListResponse<LeaveApplication>,
      ListParams
    >({
      query: (params) => {
    ...
    getSupervisorApprovals: builder.query<
      ListResponse<LeaveApplication>,
      ListParams
    >({
      query: (params) => {
    ...
    getDirectorApprovals: builder.query<
      ListResponse<LeaveApplication>,
      ListParams
    >({
      query: (params) => {
    ...
    getHrApprovals: builder.query<ListResponse<LeaveApplication>, ListParams>({
      query: (params) => {
        const p = params ?? {};
        const search = new URLSearchParams();
