...
import { useGetProgressedToDirectorateApplicationsQuery } from "@/redux/features/programme-api-slice";
import {
  ColumnFiltersState,
  PaginationState,
  SortingState,
...
function ProgrammeAccreditationData() {
  ...
  const { data, isLoading, isError } =
    useGetProgressedToDirectorateApplicationsQuery(queryParams, {
