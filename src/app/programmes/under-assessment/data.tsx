...
import { useGetProgrammeAccreditationsUnderAssessmentQuery } from "@/redux/features/programme-api-slice";
import {
    ColumnFiltersState,
    PaginationState,
    SortingState,
...
function ProgrammeAccreditationData() {
  ...
  const { data, isLoading, isError } =
    useGetProgrammeAccreditationsUnderAssessmentQuery(queryParams, {
