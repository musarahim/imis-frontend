...
import { useGetMyAppraisalsQuery } from "@/redux/features/appraisal-api-slice";
...
function AppraisalData() {
  ...
  const { data, isLoading, isError } = useGetMyAppraisalsQuery(queryParams, { refetchOnMountOrArgChange: true });

  if (isLoading) return <div>Loading...</div>;
  if (isError) return <div>Error loading appraisals.</div>;
  ...
  return (
    <DataTable<PerformanceAppraisal, unknown>
      ...
      addHref="/hr/performance_appraisal/new"
      addText="New Appraisal"
    />
  );
}
