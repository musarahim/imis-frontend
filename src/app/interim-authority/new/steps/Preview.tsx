      ...
      <Card className="w-full">
        ...
        <CardContent>
          ...
          <FieldSet>
            ...
            <FieldDescription className="p-3">
              <div dangerouslySetInnerHTML={{ __html: data?.governance_structure || '' }}/>
           ...
           <FieldSet>
            ...
            <FieldDescription className="p-3">
               <div dangerouslySetInnerHTML={{ __html: data?.human_resources || '' }}/>
            </FieldDescription>
          </FieldSet>
            <FieldSet>
            ...
            <FieldDescription className="p-3">
               <div dangerouslySetInnerHTML={{ __html: data?.action_plan || '' }}/>
            </FieldDescription>
          </FieldSet>
           <FieldSet>
            <FieldLegend>Planned Programmes of Study</FieldLegend>
            <FieldDescription className="p-3">
              <div dangerouslySetInnerHTML={{ __html: data?.programmes || '' }}/>
            </FieldDescription>
          </FieldSet>
        </CardContent>
          <CardFooter className="flex items-center justify-end gap-2">
        ...
        <CardContent>
          ...
          <FieldSet>
            ...
            <FieldDescription>
              {<FileDisplay file={data?.project_proposal}  className="pb-3 mb-3"/>}
            </FieldDescription>
          </FieldSet>
