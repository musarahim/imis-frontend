...
import { useGetProcurementExpendituresQuery } from "@/redux/features/procurement-api-slice";
import {
    ColumnFiltersState,
    PaginationState,
    SortingState,
...
function ExpenditureData() {
  ...
  const { data, isLoading, isError } = useGetProcurementExpendituresQuery(
    queryParams,
    {
  ...
  return (
    <>
      <DataTable<ProcurementExpenditure, unknown>
        ...
        addHref="/procurement/expenditure/new"
        addText="Add Expenditure"
      />
    </>
  );
}
