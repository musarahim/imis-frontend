...
import { useGetProcurementBudgetsQuery } from "@/redux/features/procurement-api-slice";
import {
    ColumnFiltersState,
    PaginationState,
    SortingState,
...
function BudgetData() {
  ...
  const { data, isLoading, isError } = useGetProcurementBudgetsQuery(
    queryParams,
    {
  ...
  return (
    <>
      <DataTable<ProcurementBudget, unknown>
        ...
        addHref="/procurement/budget/new"
        addText="Add Budget"
      />
    </>
  );
