...
import { Preview, StepB, StepC, StepD, StepE, StepF, StepG, StepH, StepI, StepJ } from "@/app/university-grant-charter/new/steps"
...
function ChartApplicationForm({...props}:props) {
...
export default ChartApplicationForm