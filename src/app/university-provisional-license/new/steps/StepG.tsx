...
function StepG({ onBack, onNext, data }: StepCProps) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    annual_budget: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    fee_structure: Yup.mixed().required("Required"),
    fees_percent_budget: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    other_income_sources: Yup.string().required("Required"),
    infrastructure_development: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    research_development: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    computer_hardware_software: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    science_lab_equipment: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    library_equipment: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    staff_development: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
    staff_salaries: Yup.number()
      .min(0, "Must be at least 0")
      .required("Required"),
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    const fileFields: (keyof FormValues)[] = ["fee_structure"];
