...
import { useGetSupervisorApprovalsQuery } from "@/redux/features/leave-api-slice";
...
function LeaveApprovalData() {
  const [pagination, setPagination] = React.useState<PaginationState>({
    ...
    const {data,isLoading,isError}=useGetSupervisorApprovalsQuery(queryParams, { refetchOnMountOrArgChange: true, });
