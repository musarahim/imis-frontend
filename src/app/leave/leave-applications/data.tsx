...
function LeaveApplicationData() {
  const [pagination, setPagination] = React.useState<PaginationState>({
    ...
    const {data,isLoading,isError}=useGetLeaveApplicationsQuery(queryParams, { refetchOnMountOrArgChange: true, });
