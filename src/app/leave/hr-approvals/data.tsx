...
function HrApprovalData() {
  const [pagination, setPagination] = React.useState<PaginationState>({
    ...
    const {data,isLoading,isError}=useGetHrApprovalsQuery(queryParams, { refetchOnMountOrArgChange: true, });
    if(isLoading) return <div>Loading...</div>
    if(isError) return <div>Error...</div>
    console.log(data, "HR Leave Approval Data after loading")
  return (
    <>
