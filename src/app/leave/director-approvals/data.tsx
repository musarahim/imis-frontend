...
function DirectorApprovalData() {
  const [pagination, setPagination] = React.useState<PaginationState>({
    ...
    const {data,isLoading,isError}=useGetDirectorApprovalsQuery(queryParams, { refetchOnMountOrArgChange: true, });
    if(isLoading) return <div>Loading...</div>
    if(isError) return <div>Error...</div>
    console.log(data, "Leave Director Approval Data after loading")
  return (
    <>
